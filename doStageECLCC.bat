...
set VER_3_6_DIR=%BIN_DIR%\ver_3_6
...
robocopy /S %TEMP%\release\bin "%VER_3_6_DIR%"
robocopy /S %TEMP%\release\libs "%VER_3_6_DIR%"
robocopy /S %TEMP%\release\dfuplus "%VER_3_6_DIR%"
robocopy /S %TEMP%\release\eclcc "%VER_3_6_DIR%"
