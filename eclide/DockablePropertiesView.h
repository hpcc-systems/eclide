...
class CDockablePropertiesView : public CDockablePane
{
// Construction
public:
	CDockablePropertiesView();
...
public:
	...
	void Send_Clear();
	void Post_Reset();
	void LoadProperties(const std::_tstring & label, Element::StringStringMap & local, Element::StringStringMap & global);
	void LoadProperties(const CComSafeArray<VARIANT> & properties);
...
// Implementation
public:
	virtual ~CDockablePropertiesView();
