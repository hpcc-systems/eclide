...
{ public:
	...
	/// Web service operation 'MyAccount' (returns error code or SOAP_OK)
	virtual	int MyAccount(_ns1__MyAccountRequest *ns1__MyAccountRequest, _ns1__MyAccountResponse *ns1__MyAccountResponse);
