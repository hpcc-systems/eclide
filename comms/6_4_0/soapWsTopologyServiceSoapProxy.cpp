...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://192.168.3.22:8010/WsTopology?ver_=1.26";
	soap_action = "WsTopology/SystemLog?ver_=1.26";
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://192.168.3.22:8010/WsTopology?ver_=1.26";
	soap_action = "WsTopology/TpClusterInfo?ver_=1.26";
	soap->encodingStyle = NULL;
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://192.168.3.22:8010/WsTopology?ver_=1.26";
	soap_action = "WsTopology/TpClusterQuery?ver_=1.26";
	soap->encodingStyle = NULL;
...
int WsTopologyServiceSoapProxy::TpDropZoneQuery(_ns5__TpDropZoneQueryRequest *ns5__TpDropZoneQueryRequest, _ns5__TpDropZoneQueryResponse *ns5__TpDropZoneQueryResponse)
{	struct soap *soap = this;
	struct __ns5__TpDropZoneQuery soap_tmp___ns5__TpDropZoneQuery;
	const char *soap_action = NULL;
	if (!soap_endpoint)
		soap_endpoint = "http://192.168.3.22:8010/WsTopology?ver_=1.26";
	soap_action = "WsTopology/TpDropZoneQuery?ver_=1.26";
	soap->encodingStyle = NULL;
	soap_tmp___ns5__TpDropZoneQuery.ns5__TpDropZoneQueryRequest = ns5__TpDropZoneQueryRequest;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns5__TpDropZoneQuery(soap, &soap_tmp___ns5__TpDropZoneQuery);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns5__TpDropZoneQuery(soap, &soap_tmp___ns5__TpDropZoneQuery, "-ns5:TpDropZoneQuery", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_connect(soap, soap_endpoint, soap_action)
	 ...
	 || soap_end_send(soap))
		return soap_closesock(soap);
	if (!ns5__TpDropZoneQueryResponse)
		return soap_closesock(soap);
	ns5__TpDropZoneQueryResponse->soap_default(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	ns5__TpDropZoneQueryResponse->soap_get(soap, "ns5:TpDropZoneQueryResponse", "");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://192.168.3.22:8010/WsTopology?ver_=1.26";
	soap_action = "WsTopology/TpGetComponentFile?ver_=1.26";
	soap->encodingStyle = NULL;
...
int WsTopologyServiceSoapProxy::TpGetServicePlugins(_ns5__TpGetServicePluginsRequest *ns5__TpGetServicePluginsRequest, _ns5__TpGetServicePluginsResponse *ns5__TpGetServicePluginsResponse)
{	struct soap *soap = this;
	struct __ns5__TpGetServicePlugins soap_tmp___ns5__TpGetServicePlugins;
	const char *soap_action = NULL;
	if (!soap_endpoint)
		soap_endpoint = "http://192.168.3.22:8010/WsTopology?ver_=1.26";
	soap_action = "WsTopology/TpGetServicePlugins?ver_=1.26";
	soap->encodingStyle = NULL;
	soap_tmp___ns5__TpGetServicePlugins.ns5__TpGetServicePluginsRequest = ns5__TpGetServicePluginsRequest;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns5__TpGetServicePlugins(soap, &soap_tmp___ns5__TpGetServicePlugins);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns5__TpGetServicePlugins(soap, &soap_tmp___ns5__TpGetServicePlugins, "-ns5:TpGetServicePlugins", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_connect(soap, soap_endpoint, soap_action)
	 ...
	 || soap_end_send(soap))
		return soap_closesock(soap);
	if (!ns5__TpGetServicePluginsResponse)
		return soap_closesock(soap);
	ns5__TpGetServicePluginsResponse->soap_default(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	ns5__TpGetServicePluginsResponse->soap_get(soap, "ns5:TpGetServicePluginsResponse", "");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://192.168.3.22:8010/WsTopology?ver_=1.26";
	soap_action = "WsTopology/TpGroupQuery?ver_=1.26";
	soap->encodingStyle = NULL;
...
int WsTopologyServiceSoapProxy::TpListTargetClusters(_ns5__TpListTargetClustersRequest *ns5__TpListTargetClustersRequest, _ns5__TpListTargetClustersResponse *ns5__TpListTargetClustersResponse)
{	struct soap *soap = this;
	struct __ns5__TpListTargetClusters soap_tmp___ns5__TpListTargetClusters;
	const char *soap_action = NULL;
	if (!soap_endpoint)
		soap_endpoint = "http://192.168.3.22:8010/WsTopology?ver_=1.26";
	soap_action = "WsTopology/TpListTargetClusters?ver_=1.26";
	soap->encodingStyle = NULL;
	soap_tmp___ns5__TpListTargetClusters.ns5__TpListTargetClustersRequest = ns5__TpListTargetClustersRequest;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns5__TpListTargetClusters(soap, &soap_tmp___ns5__TpListTargetClusters);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns5__TpListTargetClusters(soap, &soap_tmp___ns5__TpListTargetClusters, "-ns5:TpListTargetClusters", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_connect(soap, soap_endpoint, soap_action)
	 ...
	 || soap_end_send(soap))
		return soap_closesock(soap);
	if (!ns5__TpListTargetClustersResponse)
		return soap_closesock(soap);
	ns5__TpListTargetClustersResponse->soap_default(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	ns5__TpListTargetClustersResponse->soap_get(soap, "ns5:TpListTargetClustersResponse", "");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://192.168.3.22:8010/WsTopology?ver_=1.26";
	soap_action = "WsTopology/TpLogFile?ver_=1.26";
	soap->encodingStyle = NULL;
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://192.168.3.22:8010/WsTopology?ver_=1.26";
	soap_action = "WsTopology/TpLogFileDisplay?ver_=1.26";
	soap->encodingStyle = NULL;
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://192.168.3.22:8010/WsTopology?ver_=1.26";
	soap_action = "WsTopology/TpLogicalClusterQuery?ver_=1.26";
	soap->encodingStyle = NULL;
...
int WsTopologyServiceSoapProxy::TpMachineInfo(_ns5__TpMachineInfoRequest *ns5__TpMachineInfoRequest, _ns5__TpMachineInfoResponse *ns5__TpMachineInfoResponse)
{	struct soap *soap = this;
	struct __ns5__TpMachineInfo soap_tmp___ns5__TpMachineInfo;
	const char *soap_action = NULL;
	if (!soap_endpoint)
		soap_endpoint = "http://192.168.3.22:8010/WsTopology?ver_=1.26";
	soap_action = "WsTopology/TpMachineInfo?ver_=1.26";
	soap->encodingStyle = NULL;
	soap_tmp___ns5__TpMachineInfo.ns5__TpMachineInfoRequest = ns5__TpMachineInfoRequest;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns5__TpMachineInfo(soap, &soap_tmp___ns5__TpMachineInfo);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns5__TpMachineInfo(soap, &soap_tmp___ns5__TpMachineInfo, "-ns5:TpMachineInfo", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_connect(soap, soap_endpoint, soap_action)
	 ...
	 || soap_end_send(soap))
		return soap_closesock(soap);
	if (!ns5__TpMachineInfoResponse)
		return soap_closesock(soap);
	ns5__TpMachineInfoResponse->soap_default(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	ns5__TpMachineInfoResponse->soap_get(soap, "ns5:TpMachineInfoResponse", "");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://192.168.3.22:8010/WsTopology?ver_=1.26";
	soap_action = "WsTopology/TpMachineQuery?ver_=1.26";
	soap->encodingStyle = NULL;
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://192.168.3.22:8010/WsTopology?ver_=1.26";
	soap_action = "WsTopology/TpServiceQuery?ver_=1.26";
	soap->encodingStyle = NULL;
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://192.168.3.22:8010/WsTopology?ver_=1.26";
	soap_action = "WsTopology/TpSetMachineStatus?ver_=1.26";
	soap->encodingStyle = NULL;
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://192.168.3.22:8010/WsTopology?ver_=1.26";
	soap_action = "WsTopology/TpSwapNode?ver_=1.26";
	soap->encodingStyle = NULL;
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://192.168.3.22:8010/WsTopology?ver_=1.26";
	soap_action = "WsTopology/TpTargetClusterQuery?ver_=1.26";
	soap->encodingStyle = NULL;
...
int WsTopologyServiceSoapProxy::TpThorStatus(_ns5__TpThorStatusRequest *ns5__TpThorStatusRequest, _ns5__TpThorStatusResponse *ns5__TpThorStatusResponse)
{	struct soap *soap = this;
	struct __ns5__TpThorStatus soap_tmp___ns5__TpThorStatus;
	const char *soap_action = NULL;
	if (!soap_endpoint)
		soap_endpoint = "http://192.168.3.22:8010/WsTopology?ver_=1.26";
	soap_action = "WsTopology/TpThorStatus?ver_=1.26";
	soap->encodingStyle = NULL;
	soap_tmp___ns5__TpThorStatus.ns5__TpThorStatusRequest = ns5__TpThorStatusRequest;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns5__TpThorStatus(soap, &soap_tmp___ns5__TpThorStatus);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns5__TpThorStatus(soap, &soap_tmp___ns5__TpThorStatus, "-ns5:TpThorStatus", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_connect(soap, soap_endpoint, soap_action)
	 ...
	 || soap_end_send(soap))
		return soap_closesock(soap);
	if (!ns5__TpThorStatusResponse)
		return soap_closesock(soap);
	ns5__TpThorStatusResponse->soap_default(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	ns5__TpThorStatusResponse->soap_get(soap, "ns5:TpThorStatusResponse", "");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://192.168.3.22:8010/WsTopology?ver_=1.26";
	soap_action = "WsTopology/TpXMLFile?ver_=1.26";
	soap->encodingStyle = NULL;
