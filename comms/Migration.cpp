...
protected:
	...
	{
		thread_AddEclToModule(self, NULL, ModAttrPair(fromAttr->GetModuleLabel(), fromAttr->GetLabel()), fromAttr->GetType(), comment, GetText(fromAttr), fromAttr->GetModifiedBy(), fromAttr->GetModifiedDate(), sandbox);
	}
