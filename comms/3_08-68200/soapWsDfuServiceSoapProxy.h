...
{ public:
	...
	/// Web service operation 'SuperfileAddRaw' (returns error code or SOAP_OK)
	virtual	int SuperfileAddRaw(_ns3__SuperfileAddRawRequest *ns3__SuperfileAddRawRequest, _ns3__SuperfileAddRawResponse *ns3__SuperfileAddRawResponse);
