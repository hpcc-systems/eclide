...
struct __CSEEP_SEEP_EntityClassify_struct
{
    BSTR cluster_;
    BSTR queue_;
    bool include_schemas_;
...
extern __declspec(selectany) const _soapmapentry __CSEEP_SEEP_EntityClassify_entries[] =
{

    {
        ...
        offsetof(__CSEEP_SEEP_EntityClassify_struct, cluster_),
        NULL,
        NULL,
        -1,
    },
    {
        ...
        SOAPTYPE_STRING,
        SOAPFLAG_NONE | SOAPFLAG_IN | SOAPFLAG_PID | SOAPFLAG_DOCUMENT | SOAPFLAG_LITERAL | SOAPFLAG_NULLABLE,
        offsetof(__CSEEP_SEEP_EntityClassify_struct, queue_),
        NULL,
        NULL,
        -1,
    },
    {
        ...
        offsetof(__CSEEP_SEEP_EntityClassify_struct, include_schemas_),
        NULL,
        NULL,
        -1,
    },
    {
        ...
        SOAPTYPE_BOOLEAN,
		SOAPFLAG_NULLABLE | SOAPFLAG_NONE | SOAPFLAG_IN | SOAPFLAG_PID | SOAPFLAG_DOCUMENT | SOAPFLAG_LITERAL,
        offsetof(__CSEEP_SEEP_EntityClassify_struct, limitResults_),
        NULL,
        NULL,
        -1,
    },
    {
        ...
        SOAPTYPE_STRING,
        SOAPFLAG_NONE | SOAPFLAG_IN | SOAPFLAG_PID | SOAPFLAG_DOCUMENT | SOAPFLAG_LITERAL | SOAPFLAG_NULLABLE,
        offsetof(__CSEEP_SEEP_EntityClassify_struct, SParam),
        NULL,
        NULL,
        -1,
    },
    {
        ...
        offsetof(__CSEEP_SEEP_EntityClassify_struct, Contents),
        NULL,
        NULL,
        5+1,
    },
    {
        ...
        offsetof(__CSEEP_SEEP_EntityClassify_struct, __Contents_nSizeIs),
        NULL,
        NULL,
        -1
    },
    {
        ...
        SOAPTYPE_STRING,
        SOAPFLAG_NONE | SOAPFLAG_IN | SOAPFLAG_DYNARR | SOAPFLAG_PID | SOAPFLAG_DOCUMENT | SOAPFLAG_LITERAL | SOAPFLAG_NULLABLE,
        offsetof(__CSEEP_SEEP_EntityClassify_struct, Categories),
        NULL,
        NULL,
        7+1,
    },
    {
        ...
        SOAPTYPE_INT,
		SOAPFLAG_NULLABLE | SOAPFLAG_NOMARSHAL,
        offsetof(__CSEEP_SEEP_EntityClassify_struct, __Categories_nSizeIs),
        NULL,
        NULL,
        -1
    },
    {
        ...
        SOAPTYPE_STRING,
        SOAPFLAG_NONE | SOAPFLAG_IN | SOAPFLAG_PID | SOAPFLAG_DOCUMENT | SOAPFLAG_LITERAL | SOAPFLAG_NULLABLE,
        offsetof(__CSEEP_SEEP_EntityClassify_struct, Format),
        NULL,
        NULL,
        -1,
    },
    {
        ...
        offsetof(__CSEEP_SEEP_EntityClassify_struct, Exceptions),
        NULL,
        &__EspException_map,
        10+1,
    },
    {
        ...
        SOAPTYPE_INT,
		SOAPFLAG_NULLABLE | SOAPFLAG_NOMARSHAL,
        offsetof(__CSEEP_SEEP_EntityClassify_struct, __Exceptions_nSizeIs),
        NULL,
        NULL,
        -1
    },
    {
        ...
        offsetof(__CSEEP_SEEP_EntityClassify_struct, Results),
        NULL,
        NULL,
        -1,
    },
    {
        ...
        SOAPTYPE_STRING,
        SOAPFLAG_NONE | SOAPFLAG_OUT | SOAPFLAG_PID | SOAPFLAG_DOCUMENT | SOAPFLAG_LITERAL | SOAPFLAG_NULLABLE,
        offsetof(__CSEEP_SEEP_EntityClassify_struct, Workunit),
        NULL,
        NULL,
        -1,
    },
    {
        ...
        offsetof(__CSEEP_SEEP_EntityClassify_struct, Async),
        NULL,
        NULL,
        -1,
    },
...
extern __declspec(selectany) const _soapmap __CSEEP_SEEP_EntityClassify_map =
{
    0xC6CC9865,
    "SEEP.EntityClassifyRequest",
    L"SEEP.EntityClassifyResponse",
    sizeof("SEEP.EntityClassifyRequest")-1,
    sizeof("SEEP.EntityClassifyResponse")-1,
    SOAPMAP_FUNC,
    __CSEEP_SEEP_EntityClassify_entries,
    sizeof(__CSEEP_SEEP_EntityClassify_struct),
    4,
    -1,
...
{
    &__CSEEP_SEEP_EntityClassify_map,
    NULL
};

template <typename TClient>
inline HRESULT CSEEPT<TClient>::SEEP_EntityClassify(
        BSTR cluster_,
        BSTR queue_,
        bool include_schemas_,
        bool limitResults_,
    ...
    )
{
    ...
    __CSEEP_SEEP_EntityClassify_struct __params;
    ...
    __atlsoap_hr = SendRequest(_T("SOAPAction: \"/SEEP/SEEP.EntityClassify\?ver_=1.0\"\r\n"));
    if (FAILED(__atlsoap_hr))
    {
        goto __skip_cleanup;
    }
...
{
    static const _soapmapentry __CSEEP_SEEP_EntityClassify_atlsoapheader_entries[] =
    {
        { 0x00000000 }
    };

    static const _soapmap __CSEEP_SEEP_EntityClassify_atlsoapheader_map =
    {
        0xC6CC9865,
        "SEEP.EntityClassifyRequest",
        L"SEEP.EntityClassifyResponse",
        ...
        sizeof("SEEP.EntityClassifyResponse")-1,
        SOAPMAP_HEADER,
        __CSEEP_SEEP_EntityClassify_atlsoapheader_entries,
        0,
        0,
        -1,
		SOAPFLAG_NULLABLE | SOAPFLAG_NONE | SOAPFLAG_PID | SOAPFLAG_DOCUMENT | SOAPFLAG_LITERAL,
    ...
    {
        &__CSEEP_SEEP_EntityClassify_atlsoapheader_map,
        NULL
    };
