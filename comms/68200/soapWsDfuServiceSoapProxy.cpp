...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://10.173.84.202:8010/WsDfu?ver_=1.16";
	soap_action = "WsDfu/Add?ver_=1.16";
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://10.173.84.202:8010/WsDfu?ver_=1.16";
	soap_action = "WsDfu/AddRemote?ver_=1.16";
	soap->encodingStyle = NULL;
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://10.173.84.202:8010/WsDfu?ver_=1.16";
	soap_action = "WsDfu/AddtoSuperfile?ver_=1.16";
	soap->encodingStyle = NULL;
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://10.173.84.202:8010/WsDfu?ver_=1.16";
	soap_action = "WsDfu/DFUArrayAction?ver_=1.16";
	soap->encodingStyle = NULL;
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://10.173.84.202:8010/WsDfu?ver_=1.16";
	soap_action = "WsDfu/DFUBrowseData?ver_=1.16";
	soap->encodingStyle = NULL;
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://10.173.84.202:8010/WsDfu?ver_=1.16";
	soap_action = "WsDfu/DFUDefFile?ver_=1.16";
	soap->encodingStyle = NULL;
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://10.173.84.202:8010/WsDfu?ver_=1.16";
	soap_action = "WsDfu/DFUFileView?ver_=1.16";
	soap->encodingStyle = NULL;
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://10.173.84.202:8010/WsDfu?ver_=1.16";
	soap_action = "WsDfu/DFUGetDataColumns?ver_=1.16";
	soap->encodingStyle = NULL;
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://10.173.84.202:8010/WsDfu?ver_=1.16";
	soap_action = "WsDfu/DFUInfo?ver_=1.16";
	soap->encodingStyle = NULL;
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://10.173.84.202:8010/WsDfu?ver_=1.16";
	soap_action = "WsDfu/DFUQuery?ver_=1.16";
	soap->encodingStyle = NULL;
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://10.173.84.202:8010/WsDfu?ver_=1.16";
	soap_action = "WsDfu/DFUSearch?ver_=1.16";
	soap->encodingStyle = NULL;
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://10.173.84.202:8010/WsDfu?ver_=1.16";
	soap_action = "WsDfu/DFUSearchData?ver_=1.16";
	soap->encodingStyle = NULL;
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://10.173.84.202:8010/WsDfu?ver_=1.16";
	soap_action = "WsDfu/DFUSpace?ver_=1.16";
	soap->encodingStyle = NULL;
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://10.173.84.202:8010/WsDfu?ver_=1.16";
	soap_action = "WsDfu/Savexml?ver_=1.16";
	soap->encodingStyle = NULL;
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://10.173.84.202:8010/WsDfu?ver_=1.16";
	soap_action = "WsDfu/SuperfileAction?ver_=1.16";
	soap->encodingStyle = NULL;
...
int WsDfuServiceSoapProxy::SuperfileAddRaw(_ns3__SuperfileAddRawRequest *ns3__SuperfileAddRawRequest, _ns3__SuperfileAddRawResponse *ns3__SuperfileAddRawResponse)
{	struct soap *soap = this;
	struct __ns3__SuperfileAddRaw soap_tmp___ns3__SuperfileAddRaw;
	const char *soap_action = NULL;
	if (!soap_endpoint)
		soap_endpoint = "http://10.173.84.202:8010/WsDfu?ver_=1.16";
	soap_action = "WsDfu/SuperfileAddRaw?ver_=1.16";
	soap->encodingStyle = NULL;
	soap_tmp___ns3__SuperfileAddRaw.ns3__SuperfileAddRawRequest = ns3__SuperfileAddRawRequest;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns3__SuperfileAddRaw(soap, &soap_tmp___ns3__SuperfileAddRaw);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns3__SuperfileAddRaw(soap, &soap_tmp___ns3__SuperfileAddRaw, "-ns3:SuperfileAddRaw", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_connect(soap, soap_endpoint, soap_action)
	 ...
	 || soap_end_send(soap))
		return soap_closesock(soap);
	if (!ns3__SuperfileAddRawResponse)
		return soap_closesock(soap);
	ns3__SuperfileAddRawResponse->soap_default(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	ns3__SuperfileAddRawResponse->soap_get(soap, "ns3:SuperfileAddRawResponse", "");
	if (soap->error)
	{	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
			return soap_recv_fault(soap);
		return soap_closesock(soap);
...
{	struct soap *soap = this;
	...
	if (!soap_endpoint)
		soap_endpoint = "http://10.173.84.202:8010/WsDfu?ver_=1.16";
	soap_action = "WsDfu/SuperfileList?ver_=1.16";
	soap->encodingStyle = NULL;
