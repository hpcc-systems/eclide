...
class CLIB_API CDLLVersion
{
public:	// Construction/destruction:

    CDLLVersion( void );	
    virtual ~CDLLVersion( void );
...
inline BOOL CDLLVersion::IsValid( void ) const
    { return m_bValid; }

inline const VS_FIXEDFILEINFO& CDLLVersion::GetVSFFI( void ) const
    { return m_vsffi; }

////////////////////////////////////////////////////////////////////////////////

inline WORD CDLLVersion::GetFileVersionMajor( void ) const
    { ASSERT( m_bValid ); return HIWORD( m_vsffi.dwFileVersionMS ); }

inline WORD CDLLVersion::GetFileVersionMinor( void ) const
    { ASSERT( m_bValid ); return LOWORD( m_vsffi.dwFileVersionMS ); }

inline WORD CDLLVersion::GetFileVersionBuild( void ) const
    { ASSERT( m_bValid ); return HIWORD( m_vsffi.dwFileVersionLS ); }

inline WORD CDLLVersion::GetFileVersionQFE( void ) const
    { ASSERT( m_bValid ); return LOWORD( m_vsffi.dwFileVersionLS ); }

inline WORD CDLLVersion::GetProductVersionMajor( void ) const
    { ASSERT( m_bValid ); return HIWORD( m_vsffi.dwProductVersionMS ); }

inline WORD CDLLVersion::GetProductVersionMinor( void ) const
    { ASSERT( m_bValid ); return LOWORD( m_vsffi.dwProductVersionMS ); }

inline WORD CDLLVersion::GetProductVersionBuild( void ) const
    { ASSERT( m_bValid ); return HIWORD( m_vsffi.dwProductVersionLS ); }

inline WORD CDLLVersion::GetProductVersionQFE( void ) const
    { ASSERT( m_bValid ); return LOWORD( m_vsffi.dwProductVersionLS ); }

////////////////////////////////////////////////////////////////////////////////
// Translation functions

inline UINT CDLLVersion::GetTransCount( void ) const
    { ASSERT( m_bValid ); return m_nTransCnt; }

inline UINT CDLLVersion::GetCurTransIndex( void ) const
    { ASSERT( m_bValid ); return m_nTransCur; }

inline LANGID CDLLVersion::GetLIDByIndex( IN UINT nIndex  ) const
    { return LOWORD( GetTransByIndex( nIndex ) ); }	

inline WORD CDLLVersion::GetCPByIndex( IN UINT nIndex  ) const
    { return HIWORD( GetTransByIndex( nIndex ) ); }	

inline DWORD CDLLVersion::GetCurTrans( void ) const
    { return GetTransByIndex( GetCurTransIndex() ); }

inline LANGID CDLLVersion::GetCurLID( void ) const
    { return GetLIDByIndex( GetCurTransIndex() ); }

inline WORD CDLLVersion::GetCurCP( void ) const
