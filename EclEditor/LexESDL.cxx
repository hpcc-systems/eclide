...
static void ColouriseESDLDoc(unsigned int startPos, int length, int initStyle, WordList *keywordlists[],
	...
	if (styler.GetPropertyInt("lexer.ESDL.allow.dollars", 1) != 0) {
		setWordStart.Add('$');
		setWord.Add('$');
	}
...
static void ColouriseESDLDocSensitive(unsigned int startPos, int length, int initStyle, WordList *keywordlists[],
                                     Accessor &styler) {
	ColouriseESDLDoc(startPos, length, initStyle, keywordlists, styler, true);
}

static void ColouriseESDLDocInsensitive(unsigned int startPos, int length, int initStyle, WordList *keywordlists[],
                                       Accessor &styler) {
	ColouriseESDLDoc(startPos, length, initStyle, keywordlists, styler, false);
}
