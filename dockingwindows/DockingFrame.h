...
template <	class T,
			class TBase = WTL::CWindow,
            class TWinTraits = CDockingFrameTraits >
class ATL_NO_VTABLE CDockingFrameImpl:
	public CDockingFrameImplBase< T, WTL::CFrameWindowImpl< T ,TBase, TWinTraits> ,TWinTraits >
{
public:
...
class ATL_NO_VTABLE CMDIDockingFrameImpl :
	public CDockingFrameImplBase< T, WTL::CMDIFrameWindowImpl< T ,TBase, TWinTraits> ,TWinTraits >
{
public:
...
class ATL_NO_VTABLE CAutoHideMDIDockingFrameImpl :
	public CDockingFrameImplBase< T, WTL::CMDIFrameWindowImpl< T ,TBase, TWinTraits> ,TWinTraits, TAutoHidePaneTraits >
{
public:
