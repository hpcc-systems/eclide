...
class CPlainTextView:
	public WTL::CWindowImpl<CPlainTextView, WTL::CEdit, CPlainTextViewWinTraits>,
	public WTL::CEditCommands<CPlainTextView>
{
protected:
...
public:
	DECLARE_WND_SUPERCLASS(NULL, WTL::CEdit::GetWndClassName())
	...
	BEGIN_MSG_MAP(thisClass)
		...
		CHAIN_MSG_MAP_ALT(WTL::CEditCommands<CPlainTextView>, 1)
...
protected:
	...
	void InitializeFont(void)
	{
		...
		TEXTMETRIC tm = {0};
		WTL::CFontHandle oldFont = dc.SelectFont(m_font);
